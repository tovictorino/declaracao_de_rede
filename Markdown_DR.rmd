...
A primeira versão da Interface Gráfica da Declaração de Rede está disponível no [link](https://declaracaoderede6.imfast.io/DR_Interface_Grafica.html). As bases de dados, códigos e demais informações encontram-se públicas para consulta e contribuição no [GitHub](https://github.com/tovictorino/declaracao_de_rede).
