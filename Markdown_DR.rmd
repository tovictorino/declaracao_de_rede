...
O shapefile é do tipo ESRI vetorial e contém uma tabela de atributos alfa-numérica e descritiva. Nesse tipo de estrutura, a localização e a feição geométrica dos elementos são representadas por linhas poligonais com no mínimo dois vértices conectados sem, no entanto, gerar um um poligono fechado.
...
Com sintaxe concisa e funcionalidades GIS como posição georreferenciada do mouse, escala, tabela de atributos via popups e zoom, o pacote uutilizado para a construção da Interface Gráfica da Declaração de Rede foi o `mapview`.
...
A Versão 0.4 da Interface Gráfica da Declaração de Rede apresenta, na forma de pop-ups no [mapa](https://declaracaoderedev041.imfast.io/DR_Interface_Grafica.html):
...
### Controle de Versão
[v-0.4](https://declaracaoderedev041.imfast.io/DR_Interface_Grafica.html): Inclusão de ferramenta de pesquisa,  atualização da documentação e atualização das informações de capacidade da Rumo Malha Paulista e Rumo Malha Norte. 23/04/2020
