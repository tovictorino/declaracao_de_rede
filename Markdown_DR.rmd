...
A Versão 0.4 da Interface Gráfica da Declaração de Rede apresenta, na forma de pop-ups no [mapa](https://declaracaoderedev04.imfast.io/DR_Interface_Grafica.html):
...
### Controle de Versão
[v-0.4](https://declaracaoderedev04.imfast.io/DR_Interface_Grafica.html): Inclusão de ferramenta de pesquisa,  atualização da documentação e atualização das informações de capacidade da Rumo Malha Paulista e Rumo Malha Norte. 23/04/2020
